    ...
    _createClass(IndecisionApp, [{
        ...
        value: function render() {
            ...
            return React.createElement(
                ...
                React.createElement(Options, { handleRemoveAll: this.handleRemoveAll, handleRemoveOption: this.handleRemoveOption, options: this.state.options }),
...
var Options = function Options(props) {
    ...
    return React.createElement(
        ...
        options.map(function (option) {
            return React.createElement(Option, { key: option, handleRemoveOption: props.handleRemoveOption, option: option });
        })
    );
};
...
// ************* jsc with no react components **********
// const appRoot = document.getElementById('app');

// const app = {
//     title: 'Indecision App',
//     subtitle: "Let a computer decide your life's choices.",
//     options: ['item 1', 'item2'],
// }
...
//     e.preventDefault();
//     console.log('clicking selectOption');
